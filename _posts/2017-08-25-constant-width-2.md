...
$$
f_1 = x_1^2 + x_2^2 + x_3^2 \\
f_2 = x_1^4 + x_2^4 + x_3^4 \\
f_3 = x_1^6 + x_2^6 + x_3^6 \\
g_1 = 1 \\
g_2 =x_1^5x_2^3x_3 - x_1^5x_2x_3^3 - x_1^3x_2^5x_3 + x_1^3x_2x_3^5 + x_1x_2^5x_3^3 - x_1x_2^3x_3^5
$$
...
Now, we can choose any polynomial in this space to define a body of constant width with octahedral symmetry. For example, the body below has support function $$h = 1 + 3.2(x^5 y^3 z - x^3 y^5 z - x^5 y z^3 + x y^5 z^3 + x^3 y z^5 - x y^3 z^5)$$

{% include stl name="oct9.stl"  %}
